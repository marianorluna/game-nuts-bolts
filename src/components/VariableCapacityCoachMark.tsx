...
interface VariableCapacityCoachMarkProps {
  onDismiss: () => void
}
...
export function VariableCapacityCoachMark({ onDismiss }: VariableCapacityCoachMarkProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative px-4 pb-5 pt-3 text-center">
        <p className="text-sm font-medium leading-snug text-orange-100">
          {t('level.coachVariableCapacity')}
        </p>
        <button
          type="button"
          onClick={onDismiss}
